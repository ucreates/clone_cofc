...
ElixirTankTouchEndState::ElixirTankTouchEndState() {}
ElixirTankTouchEndState::~ElixirTankTouchEndState() {}
void ElixirTankTouchEndState::create(Parameter* parameter) {
    ...
    for (std::vector<GeographicNode*>::iterator it = nodeVector.begin(); it != nodeVector.end(); it++) {
        ...
        if (areaNode->geographicId == node->geographicId) {
            areaNode->type = BarrierBehaviourType::ElixirTank;
        } else {
            areaNode->type = BarrierBehaviourType::ElixirTank + BarrierBehaviourType::AroundArea;
        }
